...
class AppDelegate
    ...
    def applicationDidFinishLaunching(a_notification)
        ...
        @bootstrapWindowController = FollowListWindowController.alloc.initWithWindowNibName("FollowListWindow")
        
        window = @bootstrapWindowController.window
    end
    
    
    # Persistence accessors
    attr_accessor :persistentStoreCoordinator
    attr_accessor :managedObjectModel
    attr_accessor :managedObjectContext
    
    #
    # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "coredatamacruby" in the user's Library directory.
    #
    def applicationFilesDirectory
        ...
        library_url.URLByAppendingPathComponent("followerstalker")
    end
    ...
    def managedObjectModel
        unless @managedObjectModel
            model_url = NSBundle.mainBundle.URLForResource("followerstalker", withExtension:"momd")
    ...
    def persistentStoreCoordinator
        ...
        url = directory.URLByAppendingPathComponent("coredatamacruby.storedata")
